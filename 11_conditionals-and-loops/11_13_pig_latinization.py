...
old_str = """You would never guess what can happen when you jump into a seemingly shallow puddle at night time!
...
for i in range(len(old_str)):
    if old_str[i]==" " or old_str[i]=="\n" or old_str[i]==old_str[-1]:
        new_str += old_str[n+1]+"ay"
        n=i
    if old_str[i-1]==" ":
        continue
    if i==0:
